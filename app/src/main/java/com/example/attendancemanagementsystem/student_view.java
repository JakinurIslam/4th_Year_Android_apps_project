            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()){
                    ...
                    case R.id.item_student_home:
                        Intent shome = new Intent(student_view.this,student_home.class);
                        startActivity(shome);
                        break;
                    case R.id.item_student_attendance:
                        Intent sattendance = new Intent(student_view.this,student_attendance.class);
                        startActivity(sattendance);
                        break;
                    case R.id.item_student_course:
                        Intent scourse = new Intent(student_view.this,student_course.class);
                        startActivity(scourse);
                        break;
                    case R.id.item_student_view:
                        Intent sview = new Intent(student_view.this,student_view.class);
                        startActivity(sview);
                        break;
                    case R.id.item_student_about:
                        Intent sabout = new Intent(student_view.this,student_about.class);
