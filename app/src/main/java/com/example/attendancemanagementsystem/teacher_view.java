            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()){
                    ...
                    case R.id.item_teacher_home:
                        Intent thome = new Intent(teacher_view.this,teacher_home.class);
                        startActivity(thome);
                        break;
                    case R.id.item_teacher_attendance:
                        Intent tattendance = new Intent(teacher_view.this,teacher_attendance.class);
                        startActivity(tattendance);
                        break;
                    case R.id.item_teacher_marks:
                        Intent tmarks = new Intent(teacher_view.this,teacher_marks.class);
                        startActivity(tmarks);
                        break;
                    case R.id.item_teacher_view:
                        Intent tview = new Intent(teacher_view.this,teacher_view.class);
                        startActivity(tview);
                        break;
                    case R.id.item_teacher_about:
                        Intent tnotice = new Intent(teacher_view.this,teacher_notice.class);
